...
check "$FRESH" "F1 every migration in the converged tree applied (139 = 135 production + 4 payments)" "select $nf" "139"
check "$FRESH" "F2 Gate-2 census = 30|87|37|33 (converged EXPECT_*)" "$CENSUS" "30|87|37|33"
...
check "$PROD" "P7 census after the release = 30|87|37|33" "$CENSUS" "30|87|37|33"
