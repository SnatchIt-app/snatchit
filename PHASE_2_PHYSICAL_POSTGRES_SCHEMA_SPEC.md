...
3. `SNATCH_IT_DOMAIN_ARCHITECTURE.md` — four invariants, A1–A11, C1–C11.
4. `ARCHITECTURAL_RISK_REGISTER.md` + `CTO_DECISION_MEMO.md` — Gate-P blockers physically represented
   here (C26, C27, C33, C35, C36, C41, C42, D1/D2/D3); Gate-M/L items left as EXTENSION POINTS only.
5. `snatchit-phase0/PHASE_1_FOUNDATION.md` + `SNATCH_IT_ENGINEERING_STANDARDS.md` — Phase-0 baseline and
...
*End of PHASE_2_PHYSICAL_POSTGRES_SCHEMA_SPEC.md. Design-only. Companion deliverables (migration plan, RLS
