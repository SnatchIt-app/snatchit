...
Anywhere your admin SQL packs (`docs/operations/DAY5_ADMIN_SQL_PACK.sql`, `docs/operations/PHASE_C_ADMIN_SQL_PACK.sql`) reference `service_fee`, update to `buyer_fee` and add a `+ seller_fee` term for total platform fee.
