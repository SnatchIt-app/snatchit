...
| 16 | Tickets — turn the DEV sample toggle on, if present in this build | the sample-data caveat is legible: its ink flips with the fill rather than staying black on Daylight's dark amber | none | device-rendered |
