...
| **8** | **Light and dark appearance (app-wide)** | `V3_PACKAGE_8_APPEARANCE.md` | `pkg8-appearance-tokens.png`, `pkg8-bid-both-appearances.png`, `pkg8-bid-{dark,light}.png`, `pkg8-appearance-{dark,light}.png` | this commit | ✅ tokens + bid screen + Appearance setting; **rest of the inventory in progress** |
| **7b** | **Bid summary — the owner's final direction** | `V3_PACKAGE_7_COPY_CORRECTION.md` §2b | `pkg7-bid-after{,-raised,-annotated}.png` | `85970e23` | ✅ **supersedes §2**; three rows above `Place bid`, R-1 resolved |
| **7c** | **F-28 + the dialog-copy review** | §6b, `V3_FINDINGS_RECONCILED.md` | `pkg7-f28-marked-as-sent.png` | `5a404d6c` | ✅ F-29 recorded; one dialog body fixed, three blocked on F-27 |
| — | **Review of C, round 2** | `V3_PACKAGE_7_REVIEW_OF_C_20260923.md` §6–8 | — | `b2f65001` | ⚠️ **R-2, R-4 open**; `labelCarriesAmount` adopted from C |
...
| — | **Review of C's implementation** | `V3_PACKAGE_7_REVIEW_OF_C_20260923.md` | — | this commit | ⚠️ **3 findings open with C** (R-1 mixed units on bid entry, R-2 total twice on listing, R-3 kicker) |
