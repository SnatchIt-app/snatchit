...
> **RECONCILIATION BANNER (`AUTHZ-C1A` / `AUTHZ-C1B`; ratification rows `D13` · `D14` · `C73`).**
...
> as row **C73**, open decision **O11**, and is an **OWNER decision this pass does not make**. See §13.2.
