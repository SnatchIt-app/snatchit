...
| `kernel.refund` | `kernel.mark_refund_state` | TRANSITION | webhook | §20.7.7 | NONE (S-24 — assigned 085 by the schema spec, built by nothing) | **NOT BUILT** · OK |
...
- **4 NOT-BUILT writers** — `kernel.mark_refund_state` (`S-24`) · `venue.unpublish_holder_mix` ·
  `venue.unpublish_all_holder_mix` · the unnamed erasure trigger.
