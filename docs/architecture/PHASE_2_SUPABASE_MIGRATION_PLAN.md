...
SEAM-2 is used **eighteen** times in the MVP chain (eight pre-`OR-17` + the nine deletion hooks + the `OR-21` BP-10 predicate) — the enumeration is `kernel.settlement_royalty_lines`,
