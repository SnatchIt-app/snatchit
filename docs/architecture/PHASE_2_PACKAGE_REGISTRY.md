...
so the graph is a DAG and is topologically ordered by package number. **Total: 39 edges.**
...
> **Verified after the K-2 repair (2026-08-28).** All four sets enumerate the **same 39 edges**. Every
