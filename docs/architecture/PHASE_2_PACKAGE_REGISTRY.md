...
so the graph is a DAG and is topologically ordered by package number. **Total: 43 edges.**
...
> sets enumerate the **same 43 edges**. Every declared dependency **strictly precedes** its dependent by
...
```json
{
  ...
  "amendment_count": 7,
  "declared_edge_count": 43,
  "edge_set_parity_verified": "2026-08-28 (re-verified mechanically by the replay-ordering pass R2B after every commit: all four surfaces enumerate the same 43 edges; R2B added 081 -> 083, 078 -> 085, 081 -> 085, 083 -> 085)",
