...
- **Mobile / scanner boundary — external, NOT implemented; contract now versioned as SCANNER-CONTRACT-v1 (`docs/phase2/SCANNER_VERIFIER_CONTRACT.md`, commit c6e2675) with golden fixtures; P1-M2-HEADER recorded there:** this repository's `app/` contains no door/scan screen and no verifier; the
