...
| Tag line | **AUTHORIZED by the owner (2026-09-17): "I authorize creating candidate/2026-09-18-build-c3 at f412d10 and having C submit one sandbox preview build from that exact commit."** Tag created by A, annotated `b4c3b908`, pushed, and resolving on origin to `f412d10a1131` (tree `0409138f`). Unchanged: `candidate/2026-09-18-build-b2` → `aad5f75` (Build 18), `candidate/2026-09-18-pin-b2` → `9bef640` (sandbox application pin), `candidate/2026-09-18-pin` → `aabe029`. **Build 19 FINISHED** (C submitted once; EAS `8ebf4d81-2938-41d9-9bfd-6d20e8645325`, iOS preview, internal distribution, 1.0.0; the build record's commit `f412d10a11310167fc0227fe58ea189822bec625`, read independently by A and C; completed 2026-09-17T15:55:30Z; exactly one c3 build exists). Install: https://expo.dev/accounts/jdt_inc/projects/snatchit/builds/8ebf4d81-2938-41d9-9bfd-6d20e8645325 . **A build is not device evidence: every §6 row stays UNTESTED until run on Build 19.** W-C3, the staged notice, the round trip and the permanent transfer-test writes remain separate and unauthorized |
