...
| Candidate head | **`4331ea4`** on `release/production-gate-20260918` (0523793 = 140 @ 251cda2; 4331ea4 = c0281aa); tree `82872cf6` = the rehearsal; F-SELL-2 and B's 050 follow-up still to join | CI run *(in progress at the time of writing; recorded below when complete)* | build-source tag proposed: `candidate/2026-09-18-build-c3` — **not created until the owner's word** |
