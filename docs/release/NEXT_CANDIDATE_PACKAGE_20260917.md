...
|---|---|
| **Build** | **Hold condition met at `f412d10`:** the owner held the build until C's Keep editing fix (F-NAV-1) passed D's review and was integrated. D PASSED 2ba9e3a (product) and 76b8622 (the required test additions); A integrated it at `f412d10`. **Line 1 is issued once CI 35237352892 and D's merge-preservation gate on `f412d10` are green** |
