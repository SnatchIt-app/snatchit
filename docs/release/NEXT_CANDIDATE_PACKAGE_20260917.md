...
| Candidate head | *(to be pushed to `release/production-gate-20260918` after D's 251cda2 pass; then + F-SELL-2)* | CI run *(pending)* | build-source tag proposed: `candidate/2026-09-18-build-c3` — **not created until the owner's word** |
