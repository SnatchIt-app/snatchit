...
| A-9 ✔ | A | **PINNED Tue night at `4b012fd`** = tag `candidate/2026-09-18-pin` (D-5 PASS 22/0 clean re-run; A certified 4972/4972; docs-only commits above it). Build tree for O-2 | — | Wed AM | done early |
