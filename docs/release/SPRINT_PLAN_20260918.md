...
| **C-7** | C | Client v3 (challenge echo, pending state, visible-code fallback, refusal copy, contract pin 3); plus the K-2/131 delta and F-SELL-1 (no b2 dependency — integrate first) | A-16 (contract) | Fri 19 | `frontend/push-proof-v3`, `frontend/logout-scope`, `frontend/session-bound-131-r2`, `frontend/sell-form-keyboard` |
