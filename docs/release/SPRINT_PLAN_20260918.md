...
| C-7 ◐ | C | **Client v3 review-ready** `frontend/push-proof-v3 @ b098a46` (from 131-r2; +610/−14; built against contract v3 @ 53c95db; contract acceptance {2,3}/3; fallback verb with secret; foreground-only; DV-V1..V3 rows) — D reviews; merges after 135 + send-push. K-2/131 delta and F-SELL-1 integrated on the stack (`bf36928`), follow-ups K-5/K-6 (`27c0b7d`) and S-1 (`2b9559e`) integrated after | A-16 done | Fri 19 | stack head |
