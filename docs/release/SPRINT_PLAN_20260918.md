...
| A-18 ◐ | A | **Combined b2 commit `0e8de77` CI GREEN (35053233744); tip `9bef640`** adds C's test-only classifier-migration guard (17/17; full vitest 2061/2061; tsc 0; CI 35053607616). Pin prerequisites now: D Gate 3 on the tip + CI green at it. Then: pin → application package approval (drafted: `SANDBOX_APPLICATION_PACKAGE_B2.md`) → sandbox window → **one build** | D Gate 3 | Thu 17 pin / Fri 18 build | packet |
