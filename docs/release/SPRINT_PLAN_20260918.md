...
| **A-18** | A | Combined commit on the production-gate stack (order 135 → send-push → client v3; C's K-2/F-SELL-1 earlier), pin, CI, **one build** (owner-authorized after reviews + CI); consolidated sandbox application package for the owner's approval | A-17, B-4, C-7, D-8 | Mon 22 pin / Tue 23 build | packet |
