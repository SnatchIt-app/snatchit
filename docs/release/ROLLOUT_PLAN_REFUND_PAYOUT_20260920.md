...
|---|---|---|---|
| Migrations 143–146 + rollbacks + pgTAP 210–213 + `notify-report` `ops_alert` branch | `admin/146-alert-delivery` @ **`26e9db09`** (executable content = the reviewed `cf804036`; later commits docs + battery script only) | #86 draft | A PASS (two independent replays); CI green at `6f604efe`, `cf804036`, `70a4f613`, `26e9db09` (5461) |
