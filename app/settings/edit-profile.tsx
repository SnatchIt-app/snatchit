...
export default function EditProfileScreen() {
  ...
  useEffect(() => {
    ...
    (async () => {
      // Own profile via the SECURITY DEFINER RPC — see app/(tabs)/profile.tsx.
      // phone_number is being revoked from `authenticated`, and a direct
      // select would stop returning it even for your own row.
