...
3. If webhook failed: manually create the transfer row using DAY5_ADMIN_SQL_PACK.sql
...
**If rows found:**
1. Follow DAY5_ADMIN_DISPUTE_SOP.md
...
2. Issue manual refund via Stripe Dashboard (see DAY5_MANUAL_REFUND_PLAYBOOK.md)
...
|-----------|-----------------|----------|
| Buyer charged, no transfer | Create transfer row via SQL | DAY5_ADMIN_SQL_PACK.sql |
| Expired transfer, no refund | Manual refund via Stripe Dashboard | DAY5_MANUAL_REFUND_PLAYBOOK.md |
| Buyer confirmed, seller not paid | Manual Stripe Transfer creation | DAY5_MANUAL_REFUND_PLAYBOOK.md (Part 2) |
| Dispute pending >24h | Investigate and resolve | DAY5_ADMIN_DISPUTE_SOP.md |
