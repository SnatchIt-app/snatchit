...
**Date:** 2026-06-12 · **Scope:** ticket transfer platforms, event categories, Miami locations/venues, splash bug, admin system, report/dispute notifications, proof-of-ownership MVP, App Review safety. Research basis: `TRANSFER_METHOD_RESEARCH.md` (official sources only, created before any change).
...
**New:** `TRANSFER_METHOD_RESEARCH.md` · `UPDATED_APP_AUDIT.md` · `supabase/migrations/033_marketplace_expansion.sql` · `supabase/functions/notify-report/index.ts` · `src/constants/categories.ts`
...
git add TRANSFER_METHOD_RESEARCH.md UPDATED_APP_AUDIT.md \
