...
**Companion:** `PHASE_0_EXECUTION.md` (per-item execution tracker + apply runbook).
...
rollbacks are in `PHASE_0_EXECUTION.md` → *Ready-to-apply DB runbook*.
...
1. **Apply `066/067/068`** to production (validated, reversible; runbook in `PHASE_0_EXECUTION.md`).
