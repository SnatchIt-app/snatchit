...
-- RECONSTRUCTED 2026-09-02 (release-readiness pass) byte-for-byte from the
-- PRODUCTION ledger row supabase_migrations.schema_migrations version
-- '20260902003623' (md5 3919213d09300127d199313d95200971 over the recorded
-- statement text, verified). This migration was applied to production on
-- 2026-09-02 without being committed to the repository; this file restores
-- source-of-truth parity so a fresh replay reproduces the production catalog.
-- `db push` will NOT re-apply it (the version is already in the remote ledger).
-- Gate-2 public-function census: 69 -> 70 (dated note in ci.yml).
-- =============================================================================
...
-- guard_listing_state_columns. Historically these house listings were extended
