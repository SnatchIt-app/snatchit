...
-- Drops the eight security_invoker views and the venue_api schema. No base table,
...
-- ============================================================================
BEGIN;
DROP VIEW IF EXISTS venue_api.my_org_roles;
DROP VIEW IF EXISTS venue_api.my_staff_roles;
