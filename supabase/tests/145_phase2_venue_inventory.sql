...
SELECT is((SELECT count(*)::int FROM pg_proc p JOIN pg_namespace n ON n.oid=p.pronamespace WHERE n.nspname='venue'), 87,
  ...
  -- 2026-09-05 (package 113): 83 -> 85 (+2 door-manifest core + machine entrypoint).
  ...
  'A4: venue holds EIGHTY-SEVEN functions — 60 post-087 + 090''s nineteen + 108''s four + 113''s two + 114''s two');
