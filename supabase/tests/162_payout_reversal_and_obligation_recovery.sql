...
SELECT is((SELECT count(*)::int FROM pg_proc p JOIN pg_namespace n ON n.oid=p.pronamespace
  ...
  'P2: GATE-2 functions=87 — 096 adds no public function (70 through 20260902003623; +1 P1, +2 P2, +12 P3, +1 20260906130000; +1 20260909000000 public.get_my_tickets; pgtap''s own extension-owned functions excluded)');
