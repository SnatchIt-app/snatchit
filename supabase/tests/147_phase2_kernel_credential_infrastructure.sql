...
SELECT is((SELECT count(*)::int FROM pg_class c JOIN pg_namespace n ON n.oid=c.relnamespace
  ...
  'A1: kernel holds 32 tables — 111''s signing_key_recovery_approval + 22 post-084 + 085''s four money ledgers + 088''s dispute_native + 091''s reserve stub + 094''s organization_obligation + 096''s payout_reversal/organization_obligation_recovery');
